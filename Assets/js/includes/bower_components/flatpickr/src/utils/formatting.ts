...
import { Locale } from "Admin/Assets/js/includes/bower_components/flatpickr/src/types/locale";
import { ParsedOptions } from "Admin/Assets/js/includes/bower_components/flatpickr/src/types/options";
import { monthToStr } from "Admin/Assets/js/includes/bower_components/flatpickr/src/utils/dates";
