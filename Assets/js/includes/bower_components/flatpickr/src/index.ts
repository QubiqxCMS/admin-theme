...
import { Instance, FlatpickrFn, DayElement } from "Admin/Assets/js/includes/bower_components/flatpickr/src/types/instance";
import {
  Options,
  ParsedOptions,
  DateLimit,
  ...
  Hook,
  HookKey,
} from "Admin/Assets/js/includes/bower_components/flatpickr/src/types/options";

import { Locale, CustomLocale, key as LocaleKey } from "Admin/Assets/js/includes/bower_components/flatpickr/src/types/locale";
import English from "Admin/Assets/js/includes/bower_components/flatpickr/src/l10n/default";
...
import {
  ...
  pad,
  IncrementEvent,
} from "Admin/Assets/js/includes/bower_components/flatpickr/src/utils";
import {
  clearNode,
  createElement,
  createNumberInput,
  findParent,
  toggleClass,
} from "Admin/Assets/js/includes/bower_components/flatpickr/src/utils/dom";
import { compareDates, duration, monthToStr } from "Admin/Assets/js/includes/bower_components/flatpickr/src/utils/dates";
...
import {
  ...
  tokenRegex,
  formats,
} from "Admin/Assets/js/includes/bower_components/flatpickr/src/utils/formatting";
